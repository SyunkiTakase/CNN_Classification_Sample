...
def main(args):
    ...
    model = create_model("vgg11", pretrained=True, num_classes=len(class_names)) 
    # model = create_model("vgg11_bn", pretrained=True, num_classes=len(class_names)) 
    # model = create_model("vgg13", pretrained=True, num_classes=len(class_names)) 
    # model = create_model("vgg13_bn", pretrained=True, num_classes=len(class_names))
    # model = create_model("vgg16", pretrained=True, num_classes=len(class_names))  
    # model = create_model("vgg16_bn", pretrained=True, num_classes=len(class_names))  
    # model = create_model("vgg19", pretrained=True, num_classes=len(class_names))  
    # model = create_model("vgg19_bn", pretrained=True, num_classes=len(class_names))  
    model.to('cuda')

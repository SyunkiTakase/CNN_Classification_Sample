...
def main(args):
    ...
    # model = create_model("resnet34", pretrained=True, num_classes=len(class_names)) 
    # model = create_model("resnet50", pretrained=True, num_classes=len(class_names)) 
    # model = create_model("resnet101", pretrained=True, num_classes=len(class_names))
    # model = create_model("resnet152", pretrained=True, num_classes=len(class_names))  
    model.to('cuda')

...
def main(args):
    ...
    model = create_model("convnext_tiny", pretrained=pretrained, num_classes=len(class_names)) 
    # model = create_model("convnext_small", pretrained=pretrained, num_classes=len(class_names)) 
    # model = create_model("convnext_base", pretrained=pretrained, num_classes=len(class_names)) 
    # model = create_model("convnext_large", pretrained=pretrained, num_classes=len(class_names)) 
    model.to('cuda')
